...
const activeAuctions = [
  {
    ...
    alt:
      'Abstract digital neon card glowing in deep purple and cyan colors with futuristic circuitry patterns',
  },
  {
    title: '1964 Chronograph',
    status: 'Outbid',
    tone: 'tertiary',
    currentBid: '$12,400',
    endsIn: '22:05:12',
    ...
    alt:
      'Luxury close up of a high-end mechanical wrist watch dial with intricate gold details on a dark velvet surface',
  },
]
...
const liveFeed = [
  ['CyberPunk #88', 'Bid +0.5 ETH', 'secondary'],
  ['Gold Rolex 1950', 'Ending in 2m', 'tertiary'],
  ['Modernist Villa', 'Sold for $2.4M', 'primary'],
  ['Diamond Aura NFT', 'Bid +1.2 ETH', 'secondary'],
]
    ...
    <div className="dashboard-page">
      <nav className="dashboard-topbar">
        ...
        <div className="dashboard-topbar__actions">
          <label className="dashboard-search" aria-label="Search auctions">
          ...
          <button className="dashboard-icon-button" type="button" aria-label="Account">
      ...
      <aside className="dashboard-sidebar">
        <div className="dashboard-sidebar__profile">
          <div className="dashboard-sidebar__avatar">
            <img
              alt="Close up professional headshot of a person with neutral expression and soft studio lighting"
        ...
        <div className="dashboard-shell">
          <header className="dashboard-header">
            <div>
              ...
              <p>Track your bidding velocity and active assets.</p>
            </div>
                  ...
                  <article key={auction.title} className="dashboard-auction-card">
                    ...
                    <div className="dashboard-auction-card__body">
                      ...
                      <div className="dashboard-auction-card__meta">
                        <div><span>Current Bid</span><strong>{auction.currentBid}</strong></div>
                        <div className="dashboard-auction-card__meta-right"><span>Ends In</span><strong>{auction.endsIn}</strong></div>
                      </div>
                    </div>
                  </article>
                ))}
            ...
            <section className="dashboard-history">
              <div className="dashboard-section-head">
                ...
                <div className="dashboard-history__actions">
                  ...
                  <button type="button"><span className="material-symbols-outlined">filter_list</span>Filter</button>
                </div>
              </div>
              <div className="dashboard-table-shell">
                <table className="dashboard-table">
                  <thead>
                    <tr><th>Date</th><th>Item</th><th>Your Bid</th><th>Status</th><th className="dashboard-table__right">Action</th></tr>
                  </thead>
                  <tbody>
                    {bidHistory.map((row) => (
                      <tr key={`${row.date}-${row.item}`}>
                        ...
                        <td className="dashboard-table__right">
                          {row.action === 'rebid' ? (
                            <button className="dashboard-table__rebid" type="button">Rebid</button>
                          ) : (
                            <button className="dashboard-table__open" type="button" aria-label="Open auction"><span className="material-symbols-outlined">open_in_new</span></button>
                          )}
                        </td>
                      </tr>
                    ))}
          ...
          <section className="dashboard-feed">
            <div className="dashboard-feed__label"><span>Live Feed</span><div></div></div>
      ...
      <nav className="dashboard-mobile-nav">
        <button type="button"><span className="material-symbols-outlined">gavel</span><span>Live</span></button>
        <button className="dashboard-mobile-nav__active" type="button"><span className="material-symbols-outlined">dashboard</span><span>Dashboard</span></button>
        <button type="button"><span className="material-symbols-outlined">add_circle</span><span>Sell</span></button>
        <button type="button"><span className="material-symbols-outlined">account_balance_wallet</span><span>Wallet</span></button>
        <button type="button"><span className="material-symbols-outlined">person</span><span>Profile</span></button>
      </nav>
    </div>
  )
}
