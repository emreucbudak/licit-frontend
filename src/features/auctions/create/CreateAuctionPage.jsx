                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <span className="material-symbols-outlined pointer-events-none absolute right-2 top-1/2 flex h-8 w-8 -translate-y-1/2 items-center justify-center text-3xl leading-none text-on-surface">
                        expand_more
                      </span>
                    </div>
                  </div>
